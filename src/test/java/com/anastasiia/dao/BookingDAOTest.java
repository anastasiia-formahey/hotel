...
class BookingDAOTest {
    ...
    @Test
    void insertBooking3() throws SQLException, DAOException {
        Booking booking = new Booking();
        booking.setRoomId(200);
        booking.setClientId(2);
        booking.setCheckInDate(Date.valueOf("2023-02-25"));
        ...
        try(PreparedStatement preparedStatement = prepareMock(dataSource)){
            ...
            assertEquals(true, bookingDAO.insertBooking(bookingList));
        }
    ...
    private PreparedStatement prepareMock1(DataSource dataSource) throws SQLException {
        Connection connection = mock(Connection.class);
        PreparedStatement preparedStatement = mock(PreparedStatement.class);
        when(dataSource.getConnection()).thenReturn(connection);
        when(connection.prepareStatement(isA(String.class))).thenReturn(preparedStatement);
    ...
    @Test
    void selectAll2() throws SQLException, DAOException {
        DataSource dataSource = mock(DataSource.class);
        BookingDAO bookingDAO = new BookingDAO(dataSource);
        try(PreparedStatement preparedStatement = prepareMock(dataSource)){
            ResultSet resultSet = mock(ResultSet.class);
    ...
    @Test
    void selectAllByUserId() throws SQLException, DAOException {
        DataSource dataSource = mock(DataSource.class);
        BookingDAO bookingDAO = new BookingDAO(dataSource);
        try(PreparedStatement preparedStatement = prepareMock(dataSource)){
            ResultSet resultSet = mock(ResultSet.class);
    ...
    @Test
    void selectAllByUserId2() throws SQLException, DAOException {
        DataSource dataSource = mock(DataSource.class);
        BookingDAO bookingDAO = new BookingDAO(dataSource);
        try(PreparedStatement preparedStatement = prepareMock(dataSource)){
            ResultSet resultSet = mock(ResultSet.class);
    ...
    @Test
    void countAllBooking() throws DAOException, SQLException {
        DataSource dataSource = mock(DataSource.class);
        BookingDAO bookingDAO = new BookingDAO(dataSource);
        try(PreparedStatement preparedStatement = prepareMock(dataSource)){
            ResultSet resultSet = mock(ResultSet.class);
            ...
            int result = bookingDAO.countAllBooking();
            assertEquals(5, result);
        }
    }

    @Test
    void countAllBooking1() throws SQLException, DAOException {
        DataSource dataSource = mock(DataSource.class);
        BookingDAO bookingDAO = new BookingDAO(dataSource);
        try(PreparedStatement preparedStatement = prepareMock(dataSource)){
            ResultSet resultSet = mock(ResultSet.class);
            ...
            when(resultSet.next()).thenReturn(true).thenReturn(false);
            when(resultSet.getInt("COUNT(id)")).thenReturn(5);
            int result = bookingDAO.countAllBooking(1);
            assertEquals(5, result);
        }
    }
}