            ...
            <div class="modal-body p-5 pt-0">
                <form class="row g-3 needs-validation"  action="${pageContext.request.contextPath}/auth/"  method="post" novalidate>
                    ...
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <div style="width: 85%;float: right;"><fmt:message key="message.registrationSuccess"/></div>
                    ...
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <div style="width: 85%;float: right;"><fmt:message key="message.error"/></div>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    </c:if>
                    <c:if test="${exception ne null}">
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            <div style="width: 85%;float: right;"><fmt:message key="exception.${exception}"/></div>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </c:if>
