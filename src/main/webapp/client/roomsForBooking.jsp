        ...
        <div class="form-floating ">
          <div class="input-group">
            ...
            <input type="number" name="numberOfPerson" class="form-control" id="numberOfPerson"
                   value="${requestScope.numberOfPersonValue}" required>
            ...
            <input type="date" class=" form-control" name="checkOutDate" id="checkOutDate"
                   value="${sessionScope.checkOut}" required readonly>
            <script>
              const options1={
                year: 'numeric',
                month: 'numeric',
              ...
              function getN(){
                ...
                document.getElementById("checkOutDate").removeAttribute("readonly")
              }
            </script>
