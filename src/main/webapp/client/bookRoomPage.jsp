      ...
      <div class="row g-0">
        ...
        <form action="${pageContext.request.contextPath}/client/">
          ...
          <div class="form-floating mb-3">
            ...
            <input type="number" name="numberOfPerson" class="form-control" id="numberOfPerson" value="${sessionScope.room.getNumberOfPerson()}" readonly>
          </div>
          </div>
          <div class="form-floating mb-3">
          <div class="input-group">
            <span class="input-group-text" id="basic-addon2"><fmt:message key="form.classOfRoom"/></span>
            <input type="text" name="classOfRoom" class="form-control" id="classOfRoom" value="${sessionScope.room.getClassOfRoom()}" readonly>
          </div>
          </div>
          ...
          <div class="form-floating mb-3">
            <div class="input-group">
              ...
              <input type="text" name="checkInDate" class="form-control" id="checkInDate" value="${sessionScope.checkIn}" readonly>
            </div>
          </div>
          ...
          <div class="form-floating mb-3">
            <div class="input-group">
              ...
              <input type="text" name="checkOutDate" class="form-control" id="checkOutDate" value="${sessionScope.checkOut}" readonly>
            </div>
          </div>
          ...
          <script>
            ...
            const price = ${sessionScope.room.getPrice()}
            const checkIn = new Date(Date.parse(document.getElementById("checkInDate").value))
            const checkOut =new Date(Date.parse(document.getElementById("checkOutDate").value))
           const oneDay = 1000*60*60*24
            const diffInTime = checkOut.getTime()-checkIn.getTime()
            const diffInDays = Math.round(diffInTime/oneDay)
            const result = diffInDays *price
