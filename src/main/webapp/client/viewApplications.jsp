    ...
    <table class="table table-hover">
      ...
      <tr>
        <th scope="col">№
          ...
          <a class="link-warning" href="${pageContext.request.contextPath}/client/?command=viewApplications&orderBy=id DESC"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-sort-down" viewBox="0 0 16 16">
