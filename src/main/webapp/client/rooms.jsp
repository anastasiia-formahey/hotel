  ...
  <div class="container d-flex flex-wrap justify-content-center">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end" >
        <li><a class="dropdown-item rounded-2" href="${pageContext.request.contextPath}/client/?command=rooms&orderBy=price"><fmt:message key="form.price"/></a></li>
        <li><a class="dropdown-item rounded-2" href="${pageContext.request.contextPath}/client/?command=rooms&orderBy=number_of_person"><fmt:message key="form.numberOfPerson"/></a></li>
        <li><a class="dropdown-item rounded-2" href="${pageContext.request.contextPath}/client/?command=rooms&orderBy=class_of_room"><fmt:message key="form.classOfRoom"/></a></li>
      </ul>
    </div>
  </div>
</div>
