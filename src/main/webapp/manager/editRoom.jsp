  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <div class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="#" class="nav-link px-2 text-white"><fmt:message key="header.applications"/></a></li>
        <li><a href="#" class="nav-link px-2 text-white"><fmt:message key="header.booking"/></a></li>
      </div>
        ...
        <h2 class="featurette-heading fw-normal lh-1"><fmt:message key="edit.room"/>${sessionScope.roomEdit.getId()}</h2>
          ...
          <div class="form-floating mb-3">
            ...
            <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"></path>
              ...
              <select name="numberOfPerson" class="form-select" id="numberOfPerson" required>
                <c:forEach items="${sessionScope.capacity}" var="capacity" varStatus="loop">
                  <option
                          <c:if test="${sessionScope.roomEdit.getNumberOfPerson() eq capacity}">selected</c:if>>
                      ${capacity}</option>
                </c:forEach>
              </select>
            </div>
