    ...
    <div class="h-100 card mb-3 p-4 text-center">
      <div class="row g-0">
        <div class="table-responsive-sm">
          ...
          <p >${sessionScope.app.getId()}</p>
          <p>${sessionScope.app.getNumberOfGuests()}</p>
          <p>${sessionScope.app.getClassOfRoom()}</p>
          <p>${sessionScope.app.getLengthOfStay()}</p>
          <p>${sessionScope.app.getUserDTO().getFirstName()}
            ${sessionScope.app.getUserDTO().getLastName()}
            ${sessionScope.app.getUserDTO().getEmail()}</p>
        </div>
      </div>
