...
public class InsertRoomInReviewCommand implements Command {
    ...
    public InsertRoomInReviewCommand(AppContext appContext) {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        RoomDTO room;
        try {
            room = roomService.findRoomById(Integer.parseInt(request.getParameter(JspAttributes.NUMBER_OF_ROOM)));
